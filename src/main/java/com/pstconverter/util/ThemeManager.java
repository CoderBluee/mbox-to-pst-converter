...
public final class ThemeManager {
    ...
    public static boolean isDarkMode() {
        String activeTheme = SettingsManager.getSetting("ui_theme", "Light Mode");
    ...
    public static String getActiveThemeStylesheet() {
        String activeTheme = SettingsManager.getSetting("ui_theme", "Light Mode");
        String cssFile = "/style-light.css";
        if ("Dark Mode".equalsIgnoreCase(activeTheme)) {
            cssFile = "/style-dark.css";
        ...
        try {
            ...
            try {
                return ThemeManager.class.getResource("/style-light.css").toExternalForm();
