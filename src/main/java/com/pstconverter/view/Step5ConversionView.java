...
public class Step5ConversionView extends BorderPane implements ConversionUIContext {
    ...
    private void buildUI() {
        ...
        String startBaseStyle = "-fx-background-color: linear-gradient(to right, #4f46e5, #06b6d4); " +
                                "-fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold; " +
                                "-fx-padding: 8px 20px; -fx-background-radius: 12px; -fx-cursor: hand;";
        ...
        String pauseBaseStyle = "-fx-background-color: " + (isDark ? "rgba(245, 158, 11, 0.15)" : "rgba(245, 158, 11, 0.08)") + "; " +
                                ...
                                "-fx-border-radius: 12px; -fx-background-radius: 12px; -fx-font-size: 12px; -fx-font-weight: bold; -fx-padding: 8px 18px; -fx-cursor: hand;";
        ...
        HBox controlsBar = new HBox(12, btnPrevious, btnStart, btnPauseResume, btnStop);
        controlsBar.setPadding(new Insets(12, 16, 12, 16));
        ...
        VBox rightBox = new VBox(14, telemetryPanel, logPanel);
