...
public class ConversionTelemetryPanel extends VBox {
    ...
    public ConversionTelemetryPanel(Button btnPauseResume, Button btnStop) {
        ...
        progressSection.setStyle("-fx-background-color: rgba(255,255,255,0.03); "
                + "-fx-background-radius: 10px; -fx-border-radius: 10px; "
                + "-fx-border-color: rgba(255,255,255,0.07); -fx-padding: 14px;");
        ...
        Label fileIcon = MaterialIcons.icon(MaterialIcons.ARCHIVE, "-fx-text-fill: #818cf8; -fx-font-size: 13px;");
    ...
    public void updateCurrentLabel(String subject, String folderPath, String fileName, String destFolder) {
        Platform.runLater(() -> {
            ...
            if (fileName != null) lblCurrentFileName.setText(fileName);
