                ...
                if (empty || item == null) {
                    ...
                    switch (status) {
                        ...
                        case "FILE":
                            ...
                            textStyle = "-fx-text-fill: " + (isDarkMode ? "#c7d2fe" : "#4f46e5") + "; -fx-font-weight: 700; -fx-font-size: 13px;";
                            break;
                        default: // PENDING
                            iconL = MaterialIcons.icon(MaterialIcons.FOLDER, 13);
                            iconL.setStyle("-fx-text-fill: " + (isDarkMode ? "#cbd5e1" : "#64748b") + "; -fx-font-size: 13px;");
                            textStyle = "-fx-text-fill: " + (isDarkMode ? "#cbd5e1" : "#64748b") + "; -fx-font-size: 13px;";
                    }
