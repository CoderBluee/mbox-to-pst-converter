...
public class HelpDialog {
    ...
    public static void show(MainController controller) {
        ...
        dialog.setTitle("Help & Support Center — PST Migrator Elite");
        ...
        Label iconHelp = MaterialIcons.icon(MaterialIcons.HELP, "-fx-text-fill: #4f46e5; -fx-font-size: 28px;");
        ...
        btnOpenChat.setStyle("-fx-background-color: linear-gradient(to right, #4f46e5, #06b6d4); -fx-text-fill: white; -fx-font-weight: bold;");
    ...
    private static void addGuideStep(VBox parent, String title, String desc, boolean isDark) {
        ...
        lblTitle.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: #4f46e5;");
