...
public class CloudDestinationPanel extends VBox {
    ...
    private void handleTestConnection(boolean b) { handleTestConnection(); }
    ...
    public void styleModernTextField(MFXTextField field) {
        ...
        field.focusedProperty().addListener((o, ov, nv) -> {
            if (nv) field.setStyle("-fx-border-color: #6366f1; -fx-border-width: 2; -fx-border-radius: 4; -fx-background-radius: 4; -fx-padding: 7; -fx-font-size: 13px; -fx-background-color: #ffffff; -fx-effect: dropshadow(three-pass-box, rgba(99,102,241,0.2), 5, 0, 0, 0);");
            else field.setStyle("-fx-border-color: #e2e8f0; -fx-border-width: 1; -fx-border-radius: 4; -fx-background-radius: 4; -fx-padding: 8; -fx-font-size: 13px; -fx-background-color: #f8fafc;");
        });
    }
    ...
    private void renderCloudForm() {
        ...
        String labelColor = isDark ? "#cbd5e1" : "#475569";
        String titleColor = isDark ? "#ffffff" : "#1e293b";

        Label titleLabel = new Label(selectedFormat + " Integration");
        titleLabel.setStyle("-fx-font-size: 16px; -fx-font-weight: bold; -fx-text-fill: " + titleColor + ";");
        ...
        lblAccount.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + labelColor + ";");
        ...
        lblImapIcon.setStyle("-fx-text-fill: " + (isDark ? "#818cf8" : "#475569") + ";");

        Label lblImapMode = new Label("IMAP Migration Mode:");
        lblImapMode.setStyle("-fx-font-size: 13px; -fx-font-weight: 700; -fx-text-fill: " + titleColor + ";");
        ...
        toggleSegment.setStyle("-fx-background-color: " + (isDark ? "rgba(255,255,255,0.05)" : "#f1f5f9") + "; -fx-background-radius: 20px; -fx-padding: 4px; -fx-border-color: " + (isDark ? "rgba(255,255,255,0.1)" : "#e2e8f0") + "; -fx-border-radius: 20px;");
        ...
        loginCard.getStyleClass().add("destination-card");
        loginCard.setStyle("-fx-background-color: " + (isDark ? "#1e293b" : "#ffffff") + "; -fx-border-color: " + (isDark ? "rgba(99, 102, 241, 0.3)" : "#cbd5e1") + "; -fx-border-radius: 8px; -fx-background-radius: 8px; -fx-padding: 14px;");
        ...
        lblAuthMode.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblPreset.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblHost.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblPort.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblImapEmail.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblPassword.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblBatchTitle.setStyle("-fx-font-size: 14px; -fx-font-weight: bold; -fx-text-fill: " + titleColor + ";");
        ...
        btnImportCsv.setStyle("-fx-background-color: #4f46e5; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold; -fx-padding: 7px 14px; -fx-background-radius: 6px; -fx-cursor: hand;");
        ...
        btnOAuthAuthorize.setStyle("-fx-background-color: #4f46e5; -fx-text-fill: white; -fx-font-size: 13px; -fx-font-weight: bold; -fx-padding: 8px 16px; -fx-background-radius: 6px; -fx-cursor: hand;");
        ...
        btnBrowseJson.setStyle("-fx-background-color: #4f46e5; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold; -fx-padding: 6px 12px; -fx-background-radius: 6px; -fx-cursor: hand;");
        ...
        btnBrowseP12.setStyle("-fx-background-color: #4f46e5; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold; -fx-padding: 6px 12px; -fx-background-radius: 6px; -fx-cursor: hand;");
        ...
        o365AdminBox.setStyle("-fx-background-color: " + (isDark ? "#151d30" : "#f8fafc") + "; -fx-padding: 12px; -fx-border-color: " + (isDark ? "rgba(99, 102, 241, 0.3)" : "#cbd5e1") + "; -fx-border-radius: 8px; -fx-background-radius: 8px;");

        VBox o365EmailBox = new VBox(4);
        Label lblO365Email = new Label("Office 365 Admin Email Address");
        lblO365Email.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblTenant.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblClient.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        lblSecret.setStyle("-fx-font-size: 12px; -fx-font-weight: 600; -fx-text-fill: " + labelColor + ";");
        ...
        btnTestConnection = new MFXButton();
        btnTestConnection.setGraphic(MaterialIcons.withText(MaterialIcons.BOLT, "Test Connection"));
        btnTestConnection.setStyle("-fx-background-color: #10b981; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold; -fx-padding: 8px 16px; -fx-background-radius: 6px; -fx-cursor: hand;");
        btnTestConnection.setOnAction(e -> handleTestConnection());

        lblTestConnectionFeedback = new Label("");
        lblTestConnectionFeedback.setStyle("-fx-font-size: 11px; -fx-font-weight: bold;");
        lblTestConnectionFeedback.setVisible(false);
        lblTestConnectionFeedback.setManaged(false);
        loginTestBox.getChildren().addAll(btnTestConnection, lblTestConnectionFeedback);

        loginTestBox.visibleProperty().bind(imapBox.visibleProperty());
        loginTestBox.managedProperty().bind(loginTestBox.visibleProperty());
        loginCard.getChildren().add(loginTestBox);
        ...
        lblConnectedEmail.setStyle("-fx-font-size: 13.5px; -fx-font-weight: bold; -fx-text-fill: " + titleColor + ";");
        ...
        userMappingBox.visibleProperty().bind(javafx.beans.binding.Bindings.createBooleanBinding(() -> {
            String mode = cmbCloudAuthMode.getValue();
            return mode != null && (mode.contains("Admin") || mode.contains("Service Account") || mode.contains("Impersonation"));
        }, cmbCloudAuthMode.valueProperty()));
        ...
        nativeRoutingBox.setStyle("-fx-background-color: " + (isDark ? "rgba(30, 41, 59, 0.5)" : "#f1f5f9") + "; -fx-padding: 10px; -fx-border-color: " + (isDark ? "rgba(99, 102, 241, 0.3)" : "#cbd5e1") + "; -fx-border-radius: 6px; -fx-background-radius: 6px;");
        ...
        cbNativeItemRouting.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + titleColor + ";");
        cbNativeItemRouting.setSelected(false); // default OFF as requested!

        Label lblNativeSub = new Label("When enabled, Contacts, Calendars, & Tasks migrate directly to Google/O365 native apps instead of mail folders. Unrouted items land safely in Mail.");
        lblNativeSub.setWrapText(true);
        lblNativeSub.setStyle("-fx-font-size: 11px; -fx-text-fill: " + labelColor + ";");
        ...
        preserveHierarchyBox.setStyle("-fx-background-color: " + (isDark ? "rgba(30, 41, 59, 0.4)" : "#f8fafc") + "; -fx-padding: 10px; -fx-border-color: " + (isDark ? "rgba(99, 102, 241, 0.25)" : "#cbd5e1") + "; -fx-border-radius: 6px; -fx-background-radius: 6px;");

        cbPreserveFolderHierarchy = new MFXCheckbox("Preserve Folder Hierarchy (Direct System & Custom Folder Mirroring)");
        cbPreserveFolderHierarchy.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + titleColor + ";");
        cbPreserveFolderHierarchy.setSelected(false); // default OFF as requested!

        Label lblPreserveSub = new Label("When enabled, default folders (Inbox, Sent, Drafts, Trash, Junk) migrate directly into matching cloud system folders, and custom folders mirror directly at root.");
        lblPreserveSub.setWrapText(true);
        lblPreserveSub.setStyle("-fx-font-size: 11px; -fx-text-fill: " + labelColor + ";");
    ...
    private void switchImapMode(boolean isBatch) {
        ...
        String activeStyle = "-fx-background-color: linear-gradient(to right, #4f46e5, #6366f1); -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: 700; -fx-padding: 8px 20px; -fx-background-radius: 16px; -fx-cursor: hand; -fx-effect: dropshadow(three-pass-box, rgba(79, 70, 229, 0.25), 6, 0, 0, 2);";
        String inactiveStyle = "-fx-background-color: transparent; -fx-text-fill: #64748b; -fx-font-size: 12px; -fx-font-weight: 600; -fx-padding: 8px 20px; -fx-background-radius: 16px; -fx-cursor: hand;";
        ...
        if (file != null && file.exists()) {
            ...
            try (java.io.BufferedReader br = new java.io.BufferedReader(new java.io.FileReader(file))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (!headerSkipped && (parts[0].equalsIgnoreCase("Host") || parts[0].equalsIgnoreCase("Username") || parts[0].equalsIgnoreCase("Email"))) {
                        headerSkipped = true;
                        continue;
                    }
                    headerSkipped = true;
    ...
    private void runImapBatchVerification() {
        ...
        new Thread(() -> {
            ...
            for (ImapBatchItem item : imapBatchItemsList) {
                executor.submit(() -> {
                    com.chilkatsoft.CkImap testImap = new com.chilkatsoft.CkImap();
                    testImap.put_ConnectTimeout(10);
                    testImap.put_ReadTimeout(10);
                    testImap.put_Port(item.getPort());
                    boolean ssl = !item.getSecurity().equalsIgnoreCase("Plain") && !item.getSecurity().equalsIgnoreCase("STARTTLS");
                    testImap.put_Ssl(ssl);

                    boolean ok = testImap.Connect(item.getHost());
                    if (ok) {
                        ok = testImap.Login(item.getUsername(), item.getPassword());
                        if (ok) {
                            ...
                            String err = testImap.lastErrorText();
                            String first = err != null ? err.split("\n")[0].trim() : "Auth Failed";
                            item.setStatus("Failed: " + first);
                            failedCount.incrementAndGet();
                        }
                    } else {
                        item.setVerified(false);
                        item.setStatus("Failed: Connect Error");
                        failedCount.incrementAndGet();
                    }
                    try { testImap.delete(); } catch (Exception ignored) {}
