...
public class DestinationSettingsPanel extends VBox {
    ...
    private final List<Runnable> fieldToggleUpdaters = new ArrayList<>();
    ...
    private void buildUI() {
        ...
        lblStructure.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + labelColor + ";");
        ...
        lblAttachment.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + labelColor + ";");
        ...
        lblPdfTemplate.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + labelColor + ";");
    ...
    private void buildMetadataFieldsBox() {
        ...
        fieldsBox.setStyle("-fx-background-color: " + (isDark ? "rgba(99, 102, 241, 0.06)" : "rgba(99, 102, 241, 0.02)") + "; "
        ...
        lblFieldsIcon.setStyle("-fx-text-fill: #818cf8;");
        Label lblFieldsTitle = new Label("Include Metadata Fields in Output");
        lblFieldsTitle.getStyleClass().add("dest-form-label");
        lblFieldsTitle.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + (isDark ? "#f8fafc" : "#1e1b4b") + ";");
        ...
        btnSelectAll.setStyle("-fx-background-color: rgba(99, 102, 241, 0.15); -fx-text-fill: #a5b4fc; -fx-font-size: 10px; -fx-padding: 3px 8px; -fx-background-radius: 4px; -fx-cursor: hand;");
        MFXButton btnClearAll = new MFXButton("Clear All");
        btnClearAll.setStyle("-fx-background-color: rgba(239, 68, 68, 0.12); -fx-text-fill: #f87171; -fx-font-size: 10px; -fx-padding: 3px 8px; -fx-background-radius: 4px; -fx-cursor: hand;");
        MFXButton btnPresetsStandard = new MFXButton("Standard");
        btnPresetsStandard.setStyle("-fx-background-color: " + (isDark ? "rgba(255, 255, 255, 0.08)" : "rgba(148, 163, 184, 0.1)") + "; -fx-text-fill: " + (isDark ? "#cbd5e1" : "#475569") + "; -fx-font-size: 10px; -fx-padding: 3px 8px; -fx-background-radius: 4px; -fx-cursor: hand;");
    ...
    private HBox createFieldToggleCard(MFXCheckbox cb, String title, String iconCode) {
        ...
        icon.setStyle("-fx-text-fill: #818cf8;");
        cb.setText(title);
        ...
        Runnable updateStyle = () -> {
            ...
            cb.setStyle("-fx-font-weight: bold; -fx-font-size: 12px; -fx-text-fill: " + (isDark ? "#f8fafc" : "#1e293b") + ";");
            if (cb.isSelected()) {
                card.setStyle("-fx-background-color: " + (isDark ? "rgba(99, 102, 241, 0.22)" : "rgba(99, 102, 241, 0.08)") + "; " +
                              "-fx-border-color: " + (isDark ? "#818cf8" : "#6366f1") + "; " +
                              "-fx-border-width: 1.5px; " +
                              "-fx-border-radius: 6px; " +
                              "-fx-background-radius: 6px;");
            } else {
                card.setStyle("-fx-background-color: " + (isDark ? "#151d30" : "#ffffff") + "; " +
                              "-fx-border-color: " + (isDark ? "rgba(255,255,255,0.1)" : "#cbd5e1") + "; " +
                              "-fx-border-width: 1px; " +
                              "-fx-border-radius: 6px; " +
                              "-fx-background-radius: 6px;");
            }
        ...
        fieldToggleUpdaters.add(updateStyle);
    ...
    public void refreshStyles() {
        for (Runnable updater : fieldToggleUpdaters) {
            updater.run();
        }
    }
    ...
    private void updatePdfPreview(String template) {
        ...
        switch (template) {
            ...
            default: {
                ...
                Label lblSubj = new Label("Project Roadmap Update");
                lblSubj.setStyle("-fx-font-size: 8px; -fx-font-weight: bold; -fx-text-fill: #4f46e5;");
                Label lblFrom = new Label("From: john.doe@company.com");
    ...
    private void refreshUI() {
        ...
        String defAttach = supportsEmbed ? "Embed Attachments in " + selectedFormat : "Separate Attachment Files";
