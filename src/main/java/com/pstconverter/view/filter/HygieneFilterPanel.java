...
public class HygieneFilterPanel extends VBox {
    ...
    private HBox createHygieneRow(String title, String description, MFXCheckbox cb) {
        ...
        Runnable updateStyle = () -> {
            ...
            if (isDark) {
                row.setStyle("-fx-background-color: " + (cb.isSelected() ? "rgba(99, 102, 241, 0.1)" : "rgba(255,255,255,0.02)") + "; -fx-border-color: " + (cb.isSelected() ? "#6366f1" : "rgba(255,255,255,0.08)") + "; -fx-border-width: 1px; -fx-border-radius: 6px; -fx-background-radius: 6px; -fx-cursor: hand;");
                ...
                row.setStyle("-fx-background-color: " + (cb.isSelected() ? "rgba(79, 70, 229, 0.03)" : "rgba(0,0,0,0.01)") + "; -fx-border-color: " + (cb.isSelected() ? "#4f46e5" : "rgba(0,0,0,0.08)") + "; -fx-border-width: 1px; -fx-border-radius: 6px; -fx-background-radius: 6px; -fx-cursor: hand;");
