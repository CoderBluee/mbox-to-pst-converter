...
public class SenderRecipientFilterPanel extends VBox {
    ...
    private javafx.scene.control.CheckBox cbDomainMatch;
    ...
    private void buildUI() {
        ...
        cbDomainMatch = new javafx.scene.control.CheckBox("Domain-level matching (wildcard)");
        cbDomainMatch.getStyleClass().add("filter-checkbox");
        cbDomainMatch.setStyle("-fx-text-fill: #ffffff; -fx-font-size: 12.5px; -fx-font-weight: 600; -fx-cursor: hand;");
